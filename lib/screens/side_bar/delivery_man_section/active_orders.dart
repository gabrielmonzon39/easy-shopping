...
class ActiveOrders extends StatefulWidget {
  ...
  @override
  ActiveOrdersBuilder createState() => ActiveOrdersBuilder();
}

class ActiveOrdersBuilder extends State<ActiveOrders> {
  ...
  Future<bool> getActiveOrders() async {
        ...
        if ((await FirebaseFS.getProjectId(document.get('user_id'))) ==
          ...
          for (var document2 in snapDelivery.docs) {
            if (document2.id == del.toString() &&
                document2.get('delivery_man_id') == DELIVERY_PENDING) {
    ...
    if (available) {
      ...
      result = Center(
        ...
        Text(
          "¡Ups! Parece que no se encuentran órdenes activas por el momento. Nosotros te avisaremos cuando exista una orden activa.",
          style: TextStyle(
            fontSize: 20,
            fontWeight: FontWeight.w600,
            color: Colors.black,
